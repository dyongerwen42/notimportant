...
function emitLog(socketId: string, taskId: string, message: string, type: 'info' | 'success' | 'error' | 'warn' = 'info') {
...
async function executeTransactionForTask(task: any) {
...
async function sendFeeSeparately(task: any) {
